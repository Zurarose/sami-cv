...
const Experience = z.object({
  ...
  startDate: z.string().describe('The start date of the experience'),
  endDate: z.string().describe('The end date of the experience'),
...
const Document = z.object({
  ...
  website: z.string().describe('The website of the applicant'),
